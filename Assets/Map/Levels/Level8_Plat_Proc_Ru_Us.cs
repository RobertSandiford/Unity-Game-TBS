...
public static partial class LevelDefs
{
    ...
    public static Level level8 = new Level
    {
        ...
        platoons = new List<MapPlatoon> {
            ...
            new MapPlatoon(1, "base", new int[] { 2, 2 }, PlatoonGroupDefs.PlatoonGroup_RU_Motor_Rifle_Bmp2), // MR BMP Platoon Group
            new MapPlatoon(1, "base", new int[] { 5, 1 }, PlatoonGroupDefs.PlatoonGroup_RU_Motor_Rifle_Bmp2), // MR BMP Platoon Group
            ...
            // fixed pos for testing
            /*
            new MapPlatoon(2, "pos", new int[] { 16, 11 }, PlatoonDefs.Platoon_US_Abrams_M1A2C), // Abrams Tank Platoon

            new MapPlatoon(2, "pos", new int[] { 18, 11 }, PlatoonDefs.Platoon_US_Mech_Inf_Coy_Hq), // Bradley Mech Inf Coy HQ Platoon Group
            new MapPlatoon(2, "pos", new int[] { 20, 11 }, PlatoonGroupDefs.PlatoonGroup_US_Mech_Inf), // Bradley Mech Inf Platoon Group
            new MapPlatoon(2, "pos", new int[] { 17, 12 }, PlatoonGroupDefs.PlatoonGroup_US_Mech_Inf), // Bradley Mech Inf Platoon Group
            new MapPlatoon(2, "pos", new int[] { 15, 14 }, PlatoonGroupDefs.PlatoonGroup_US_Mech_Inf), // Bradley Mech Inf Platoon Group

            new MapPlatoon(2, "pos", new int[] { 14, 13 }, PlatoonDefs.Platoon_US_M121_120mm_Mortar) // Mortar Platoon from Battallion, Platoon
            */

            // random pos
            
            new MapPlatoon(2, "base", PlatoonDefs.Platoon_US_Abrams_M1A2C), // Abrams Tank Platoon

            new MapPlatoon(2, "base", PlatoonDefs.Platoon_US_Mech_Inf_Coy_Hq), // Bradley Mech Inf Coy HQ Platoon Group
            new MapPlatoon(2, "base", PlatoonGroupDefs.PlatoonGroup_US_Mech_Inf), // Bradley Mech Inf Platoon Group
            new MapPlatoon(2, "base", PlatoonGroupDefs.PlatoonGroup_US_Mech_Inf), // Bradley Mech Inf Platoon Group
            new MapPlatoon(2, "base", PlatoonGroupDefs.PlatoonGroup_US_Mech_Inf), // Bradley Mech Inf Platoon Group

            new MapPlatoon(2, "base", PlatoonDefs.Platoon_US_M121_120mm_Mortar) // Mortar Platoon from Battallion, Platoon
